...
```
> git clone https://github.com/UniversityofPortland/moodle-assignfeedback_mahara.git {Moodle_Root}/mod/assign/feedback/mahara
```
...
[2]: https://github.com/UniversityofPortland/moodle-local_mahara
